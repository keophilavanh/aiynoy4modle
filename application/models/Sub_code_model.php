...
class Sub_code_model extends MY_Model{
    ...
    {  
         ...
         {  
              $this->db->like("sub_code_id", $_POST["search"]["value"]);  
         ...
         {  
              $this->db->order_by('sub_code_id', 'DESC');  
         }  
    }  
