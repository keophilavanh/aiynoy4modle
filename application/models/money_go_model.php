...
class money_go_model extends MY_Model{
    ...
    {  
         ...
         {  
              $this->db->like("money_go_id", $_POST["search"]["value"]);  
         ...
         {  
              $this->db->order_by('money_go_id', 'DESC');  
         }  
    }  
