...
class Floor_model extends MY_Model{
    ...
    var $order_column = array("floor_id", "floor_name");  
    function make_query()  
    {  
         $this->db->select('*');  
         ...
         {  
              $this->db->like("floor_id", $_POST["search"]["value"]);  
              $this->db->or_like("floor_name", $_POST["search"]["value"]);  
