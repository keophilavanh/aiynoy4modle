    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/font-face/stylesheet.css') ?>">
    <link rel="stylesheet" href="<?php echo base_url('assets/css/datatables.min.css') ?>">
    <link rel="stylesheet" href="<?php echo base_url('assets/css/jquery.toast.css') ?>">
    <link rel="stylesheet" href="<?php echo base_url('assets/css/jquery.datetimepicker.min') ?>">
    ...
    <script src="<?php echo base_url('assets/js/bootadmin.min.js') ?>"></script>
