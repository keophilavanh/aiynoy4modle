...
<div class="d-flex">
    ...
    <div class="content p-4">
        <h2 class="mb-4">ລະຫັດຍ່ອຍ</h2>

        <div class="card mb-4">
            <div class="card-body">
                    <div align="right">   
                    <button type="button" class="btn btn-success" title="ເພີ້ມ" name="add" id="add" >ເພີ້ມຂໍ້ມູນລະຫັດຍ່ອຍ</button>
            ...
            <table class="table table-bordered" id="test_table"  cellspacing="0" width="100%">
                ...
                <form method="post" id="insert_form" autocomplete="off">
                            ...
                            <div class="form-group row">
                                ...
                                <br />
                                <input type="hidden" name="sub_code_id" id="sub_code_id" />
...
<script type="text/javascript" language="javascript" >  
 $(document).ready(function(){  
      var dataTable = $('#test_table').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?php echo base_url() . 'Sub_code/fetch_data'; ?>",  
                type:"POST"  
           },  
           "columnDefs":[  
                {  
      ...
      $('#add').click(function () {
           ...
           {  
           $.ajax({  
               url:"<?php echo base_url() . 'Sub_code/additem'; ?>",  
               method:"POST",  
           ...
           $(document).on('click', '.edit_data', function(){  
                var sub_code_id = $(this).attr("id");  
                
                $.ajax({  
                    url:"<?php echo base_url() . 'Sub_code/getitem'; ?>", 
                    method:"POST",  
                    data:{sub_code_id:sub_code_id},  
                    dataType:"json",  
                    success:function(data){  
                        ...
                        $('#sub_code_id').val(data.sub_code_id);  
                    
                       
                        $('#add_data_Modal').modal('show');
                        $('#insert').val("ແກ້ໄຂຂໍ້ມູນລະຫັດຍ່ອຍ");
                        $('#status').val('Update');  
                    }  
                });  
            });
                ...
                var status ='Delete';
                 swal({
                        ...
                        if (willDelete) {
                            ...
                            $.ajax({  
                                    url:"<?php echo base_url() . 'Sub_code/deletVendor'; ?>", 
                                    method:"POST",  
