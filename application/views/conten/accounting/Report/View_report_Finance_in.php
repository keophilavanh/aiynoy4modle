    ...
    ?>
        ...
        <div class="content p-4">
            ...
            <div class="card mb-4">
                ...
                <br/>
                <center>
                <h1>ລາຍງານໃບອະຍຸມັດລາຍຮັບ </h1>
                </center>
                <br/>
                <br/>
                <form name="myForm" id="myForm" action="Print-Report-Finance-IN" target="_blank" method="post" autocomplete="off" onsubmit="return toSubmit();" >
