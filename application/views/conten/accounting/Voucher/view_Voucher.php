        ...
        <div class="card mb-4">
            ...
            <table class="table table-bordered" id="test_table"  cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <th scope="col">ເອກະສານຢັ້ງຢືນ / Ref Doc</th>  
...
<script type="text/javascript" language="javascript" >  
 $(document).ready(function(){  
      var dataTable = $('#test_table').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?php echo base_url() . 'Voucher/fetch_invoice'; ?>",  
                type:"POST"  
           },  
           "columnDefs":[  
                {  
                ...
                var voucher_id = $(this).attr("id");  
                 ...
                 swal({
                        ...
                        if (willDelete) {
                            ...
                            $.ajax({  
                                    url:"<?php echo base_url() . 'Voucher/Edit_invoice'; ?>", 
                                    method:"POST",  
