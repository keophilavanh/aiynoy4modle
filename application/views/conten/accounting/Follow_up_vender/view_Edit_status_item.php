                            ...
                            <tbody>
                                    ...
                                    <?php
                                        ...
                                        if($row->status){
                                            ...
                                            $status ='<input type="checkbox" class="form-check-input" Name="Check" id="exampleCheck'.++$i.'" value="'.$row->id.'">';
                                        }
                ...
                if(checked_total == 0  ){
                    ...
                    swal({
                        ...
                        if (willDelete) {
                            ...
                            $.ajax({  
                                    url:"<?php echo base_url() . 'vendor_invoice/mark_invoice'; ?>", 
                                    method:"POST",  
