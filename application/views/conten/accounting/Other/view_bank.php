...
<div class="d-flex">
    ...
    <div class="content p-4">
        <h2 class="mb-4">ທະນາຄານ</h2>

        <div class="card mb-4">
            <div class="card-body">
                    <div align="right">   
                    <button type="button" class="btn btn-success" title="ເພີ້ມ" name="add" id="add" >ເພີ້ມຂໍ້ມູນທະນາຄານ</button>
...
<script type="text/javascript" language="javascript" >  
 $(document).ready(function(){  
      var dataTable = $('#test_table').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?php echo base_url() . 'bank/fetch_data'; ?>",  
                type:"POST"  
           },  
           "columnDefs":[  
                {  
      ...
      $('#add').click(function () {
           ...
           {  
           $.ajax({  
               url:"<?php echo base_url() . 'bank/additem'; ?>",  
               method:"POST",  
           ...
           $(document).on('click', '.edit_data', function(){  
                ...
                $.ajax({  
                    url:"<?php echo base_url() . 'bank/getitem'; ?>", 
                    method:"POST",  
                ...
                var status ='Delete';
                 swal({
                        ...
                        if (willDelete) {
                            ...
                            $.ajax({  
                                    url:"<?php echo base_url() . 'bank/deletVendor'; ?>", 
                                    method:"POST",  
