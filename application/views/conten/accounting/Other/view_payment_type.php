...
<div class="d-flex">
    ...
    <div class="content p-4">
        <h2 class="mb-4">ປະເພດການຈ່າຍ</h2>

        <div class="card mb-4">
            <div class="card-body">
                    <div align="right">   
                    <button type="button" class="btn btn-success" title="ເພີ້ມ" name="add" id="add" >ເພີ້ມຂໍ້ມູນປະເພດການຈ່າຍ</button>
            ...
            <table class="table table-bordered" id="test_table"  cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <th scope="col">ຊື່ປະເພດການຈ່າຍ</th>
...
<script type="text/javascript" language="javascript" >  
 $(document).ready(function(){  
      var dataTable = $('#test_table').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?php echo base_url() . 'Payment_Type/fetch_data'; ?>",  
                type:"POST"  
           },  
           "columnDefs":[  
                {  
      ...
      $('#add').click(function () {
           ...
           {  
           $.ajax({  
               url:"<?php echo base_url() . 'Payment_Type/additem'; ?>",  
               method:"POST",  
           ...
           $(document).on('click', '.edit_data', function(){  
                ...
                $.ajax({  
                    url:"<?php echo base_url() . 'Payment_Type/getitem'; ?>", 
                    method:"POST",  
                    data:{pay_id:pay_id},  
                    dataType:"json",  
                    success:function(data){  
                        ...
                        $('#add_data_Modal').modal('show');
                        $('#insert').val("ແກ້ໄຂຂໍ້ມູນປະເພດການຈ່າຍ");
                        $('#status').val('Update');  
                    }  
                });  
            });
