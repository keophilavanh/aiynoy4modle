...
<div class="d-flex">
    ...
    <div class="content p-4">
        <h2 class="mb-4">ປືື້ມບັນຊີ</h2>

        <div class="card mb-4">
            <div class="card-body">
                    <div align="right">   
                    <button type="button" class="btn btn-success" title="ເພີ້ມ" name="add" id="add" >ເພີ້ມຂໍ້ມູນປືື້ມບັນຊີ</button>
...
<script type="text/javascript" language="javascript" >  
 $(document).ready(function(){  
      var dataTable = $('#test_table').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?php echo base_url() . 'Book_accounting/fetch_data'; ?>",  
                type:"POST"  
           },  
           "columnDefs":[  
                {  
      ...
      $('#add').click(function () {
           ...
           {  
           $.ajax({  
               url:"<?php echo base_url() . 'Book_accounting/additem'; ?>",  
               method:"POST",  
           ...
           $(document).on('click', '.edit_data', function(){  
                ...
                $.ajax({  
                    url:"<?php echo base_url() . 'Book_accounting/getitem'; ?>", 
                    method:"POST",  
                    ...
                    success:function(data){  
                        ...
                        $('#add_data_Modal').modal('show');
                        $('#insert').val("ແກ້ໄຂຂໍ້ມູນປືື້ມບັນຊີ");
                        $('#status').val('Update');  
                    }  
                });  
            });
