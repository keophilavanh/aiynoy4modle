...
<div class="d-flex">
    ...
    <div class="content p-4">
        <h2 class="mb-4">ປະເພດເງີນສົດ</h2>

        <div class="card mb-4">
            <div class="card-body">
                    <div align="right">   
                    <button type="button" class="btn btn-success" title="ເພີ້ມ" name="add" id="add" >ເພີ້ມຂໍ້ມູນປະເພດເງີນສົດ</button>
            ...
            <table class="table table-bordered" id="test_table"  cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <th scope="col">ຊື່ປະເພດເງີນສົດ</th>
...
<script type="text/javascript" language="javascript" >  
 $(document).ready(function(){  
      var dataTable = $('#test_table').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?php echo base_url() . 'Money_type/fetch_data'; ?>",  
                type:"POST"  
           },  
           "columnDefs":[  
                {  
      ...
      $('#add').click(function () {
           ...
           {  
           $.ajax({  
               url:"<?php echo base_url() . 'Money_type/additem'; ?>",  
               method:"POST",  
           ...
           $(document).on('click', '.edit_data', function(){  
                var money_id = $(this).attr("id");  
                
                $.ajax({  
                    url:"<?php echo base_url() . 'Money_type/getitem'; ?>", 
                    method:"POST",  
                    ...
                    success:function(data){  
                        ...
                        $('#add_data_Modal').modal('show');
                        $('#insert').val("ແກ້ໄຂຂໍ້ມູນປະເພດເງີນສົດ");
                        $('#status').val('Update');  
                    }  
                });  
            });
                ...
                var status ='Delete';
                 swal({
                        ...
                        if (willDelete) {
                            ...
                            $.ajax({  
                                    url:"<?php echo base_url() . 'Payment_Type/deletVendor'; ?>", 
                                    method:"POST",  
