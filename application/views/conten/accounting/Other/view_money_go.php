...
<div class="d-flex">
    ...
    <div class="content p-4">
        <h2 class="mb-4">ປາຍທາງການເງີນ</h2>

        <div class="card mb-4">
            <div class="card-body">
                    <div align="right">   
                    <button type="button" class="btn btn-success" title="ເພີ້ມ" name="add" id="add" >ເພີ້ມຂໍ້ມູນການເງີນ</button>
            ...
            <table class="table table-bordered" id="test_table"  cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <th scope="col">ຊື່ຂໍ້ມູນການເງີນ</th>
                ...
                <form method="post" id="insert_form" autocomplete="off">
                            ...
                            <div class="form-group row">
                                ...
                                <br />
                                <input type="hidden" name="money_go_id" id="money_go_id" />
...
<script type="text/javascript" language="javascript" >  
 $(document).ready(function(){  
      var dataTable = $('#test_table').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?php echo base_url() . 'money_go/fetch_data'; ?>",  
                type:"POST"  
           },  
           "columnDefs":[  
                {  
      ...
      $('#add').click(function () {
           ...
           {  
           $.ajax({  
               url:"<?php echo base_url() . 'money_go/additem'; ?>",  
               method:"POST",  
           ...
           $(document).on('click', '.edit_data', function(){  
                var money_go_id = $(this).attr("id");  
                
                $.ajax({  
                    url:"<?php echo base_url() . 'money_go/getitem'; ?>", 
                    method:"POST",  
                    data:{money_go_id:money_go_id},  
                    dataType:"json",  
                    success:function(data){  
                        ...
                        $('#money_go_id').val(data.money_go_id);  
                ...
                var status ='Delete';
                 swal({
                        ...
                        if (willDelete) {
                            ...
                            $.ajax({  
                                    url:"<?php echo base_url() . 'money_go/deletVendor'; ?>", 
                                    method:"POST",  
